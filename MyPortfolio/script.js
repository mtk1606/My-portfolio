    ...
    return `
      ...
      <div class="projects-grid">
        <div class="project-card">
          <h4>AstraSage</h4>
          <p>Student services marketplace MVP built to connect students with local gigs such as cleaning moving and seasonal work. I led product design build and initial operations.</p>
          <div class="project-tech">
            <span class="tech-tag">Product Strategy</span>
            <span class="tech-tag">MVP Launch</span>
            <span class="tech-tag">Operations</span>
          </div>
          <p><strong>Outcome:</strong> Validated demand and secured first paid customer using a simple booking prototype and playbook</p>
        </div>
...
getSkillsContent() {
 ...
 getSocialContent() {
    return `
      ...
      <p style="margin-top:12px;">If you want the resume PDF link or specific project repo links injected now tell me and I will add them into the windows for you.</p>
    </div>
  `;
}
