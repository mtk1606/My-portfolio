...
class DesktopPortfolio {
    ...
    return `
      ...
      <h2>About Me</h2>
      <p>Hi I am <strong>Moahmed Taha El Khoudimi</strong>. I am a product minded engineer and founder focusing on building practical, reliable products that deliver measurable results. I combine product strategy, user research, and lightweight engineering to ship quickly, test assumptions, and improve outcomes.</p>

      <h3>Background</h3>
      <p>I arrived in Canada to study mechanical engineering and transitioned into product and software work. I built and ran HireStudent, worked at NTT, and managed operations at Emporio Models. I have hands on experience launching MVPs, automating workflows, and validating product market fit.</p>

      <h3>How I work</h3>
      <ul>
        <li>Customer discovery and focused interviews to find the riskiest assumptions</li>
        <li>Define outcome driven goals and prioritize what moves the metric needle</li>
        <li>Rapid prototyping and iterative delivery using Figma Framer or simple React builds</li>
        <li>Coordinate cross functional teams to deliver end to end from idea to launch</li>
      </ul>

      <h3>Signals</h3>
      <ul>
        <li>Founder of HireStudent and AstraSage with validated pilot customers</li>
        <li>Completed machine learning coursework with a 90 percent score and applying ML to product problems</li>
        <li>Comfortable with product tools and simple engineering stacks Figma Notion Python SQL React</li>
      </ul>
    </div>
  `;
}
...
getResumeContent() {
    return `
      ...
      <div style="margin-bottom: 18px;">
        <h4>Founder and Operator — HireStudent</h4>
        <p>Moncton NB | 01/2022 - Present</p>
        <ul>
          <li>Launched a student services platform and seasonal pilot including Christmas light installation</li>
          <li>Served approximately 120 customers and processed around 300 bookings during pilot and holiday seasons</li>
          <li>Built automation scripts and intake forms using Google Apps Script to automate scheduling and reduced manual coordination time by about 40 percent</li>
          <li>Collected user feedback and iterated on service flows to improve fulfilment speed and quality</li>
        </ul>
      </div>

      <div style="margin-bottom: 18px;">
        <h4>Fraud Analyst and Customer Support — NTT Corporation</h4>
        <p>Moncton NB | 01/2023 - 09/2024</p>
        <ul>
          <li>Investigated transactional cases and produced concise reports for escalation</li>
          <li>Automated reporting templates and standardized case tracking to improve team handover efficiency</li>
        </ul>
      </div>

      <div style="margin-bottom: 18px;">
        <h4>Operations Coordinator — Emporio Models</h4>
        <p>Remote Dubai | 06/2018 - 05/2022</p>
        <ul>
          <li>Streamlined onboarding checklists and operations workflows with templates and documentation</li>
          <li>Improved delivery consistency and reduced onboarding time by about 30 percent</li>
        </ul>
      </div>

      <div style="margin-bottom: 18px;">
        <h4>Founder — AstraSage</h4>
        <p>Product Launch and Operations | 2024 - Present</p>
        <ul>
          <li>Built an MVP marketplace connecting students with local gigs, designed the booking and onboarding flow</li>
          <li>Secured first paid customer during early pilots and validated pricing and onboarding assumptions</li>
          <li>Created an operational playbook to scale seasonal services</li>
        </ul>
      </div>

      <h3>Education</h3>
      <div style="margin-bottom: 12px;">
        <h4>Degree in Computer Programming — Georgian College</h4>
        <p>Barrie ON | 01/2025 - 08/2026</p>
      </div>

      <div style="margin-bottom: 12px;">
        <h4>Bachelor in Mechanical Engineering — Université de Moncton</h4>
        <p>Moncton NB | 08/2020 - 05/2024</p>
      </div>

      <h3>Certifications</h3>
      <ul>
        <li>Coursera Machine Learning and Social Projects with Machine Learning — score 90 percent</li>
        <li>Studying additional practical ML and AI coursework</li>
      </ul>

      <h3>Contact</h3>
      <ul>
        <li>Email: mokhoudimi@gmail.com</li>
        <li>Phone: 506 406 4185</li>
        <li>LinkedIn: linkedin.com/in/mtk1606/</li>
        <li>GitHub: github.com/mtk1606</li>
      </ul>
    </div>
  `;
}
...
getProjectsContent() {
    return `
      ...
      <p>Selected projects that demonstrate product thinking development and delivery.</p>

      <div class="projects-grid">
       <div class="project-card">
  <h4>AstraSage — Market Research & Product Strategy</h4>
  <p>Consulting and research services for startups and local businesses focusing on market validation, competitive analysis, and product strategy. Built data dashboards and explored AI-assisted automation for insights generation and reporting.</p>
  <div class="project-tech">
    <span class="tech-tag">Market Research</span>
    <span class="tech-tag">Product Management</span>
    <span class="tech-tag">Data Analysis</span>
  </div>
  <p><strong>Website:</strong> <a href="https://astrasage.com" target="_blank" rel="noopener noreferrer">astrasage.com</a></p>
</div>


        <div class="project-card">
          <h4>HireStudent</h4>
          <p>Pilot platform for student labour covering seasonal bookings. Built intake automation and scheduling to reduce manual work and improve fulfillment.</p>
          <div class="project-tech">
            <span class="tech-tag">Automation</span>
            <span class="tech-tag">Go to market</span>
            <span class="tech-tag">Customer validation</span>
          </div>
          <p><strong>Outcome:</strong> Approximately 300 bookings and repeat customers during pilots</p>
        </div>

        <div class="project-card">
          <h4>Product delivery — Emporio Models and NTT tasks</h4>
          <p>Operational improvements and product level delivery work focusing on onboarding flows efficiency and reporting automation.</p>
          <div class="project-tech">
            <span class="tech-tag">Process improvement</span>
            <span class="tech-tag">Reporting automation</span>
            <span class="tech-tag">Stakeholder coordination</span>
          </div>
        </div>

        <div class="project-card">
          <h4>Personal Tech Projects</h4>
          <p>Data analysis automation tools and a portfolio prototype using React Firebase and basic ML prototypes for classification and recommendations.</p>
          <div class="project-tech">
...
getSkillsContent() {
    return `
      ...
      <p>Core technical and product skills used to deliver results.</p>

      <div class="skills-grid">
        <div class="skill-category">
          <h4>Technical</h4>
          <ul>
            <li>Python Java SQL JavaScript React</li>
            <li>REST APIs Docker basic AWS</li>
            <li>Unit testing and CI workflows</li>
          </ul>
        </div>
        ...
        <div class="skill-category">
          <h4>Product</h4>
          <ul>
            <li>Product discovery user research and roadmapping</li>
            <li>Prioritization and metrics driven decision making</li>
            <li>Prototyping and design handoffs with Figma and Framer</li>
          </ul>
        </div>

        <div class="skill-category">
          <h4>Operations and Tools</h4>
          <ul>
            <li>Notion Google Apps Script Vercel GitHub</li>
            <li>PostgreSQL MongoDB Firebase</li>
            <li>Google Analytics and basic event tracking</li>
          </ul>
        </div>
 ...
 getContactContent() {
    return `
        <div class="content-section">
      <h2>Contact</h2>
      <p>I respond to serious co op internship and product opportunities. I prefer remote or hybrid roles in Canada but will consider strong offers elsewhere.</p>
      ...
      <div class="contact-info">
        ...
        <div class="contact-item">
          ...
          <div class="contact-details">
            <h4>LinkedIn</h4>
            <p>linkedin.com/in/mtk1606/</p>
          </div>
        </div>
      </div>

      <h3>Availability</h3>
      <p>Open to co op internship and product roles. Will reply within 24 to 48 hours to relevant messages.</p>
    </div>
  `;
}
 ...
 getSocialContent() {
    return `
         <div class="content-section">
      <h2>Social and Links</h2>
      <p>Find my work and reach out.</p>

      <div class="social-links">
        <a href="https://www.linkedin.com/in/mtk1606/" class="social-link" target="_blank">
        ...
        <a href="mailto:mokhoudimi@gmail.com" class="social-link" target="_blank">
        ...
        <a href="https://github.com/mtk1606" class="social-link" target="_blank">
          <div class="social-icon github">💻</div>
          <div class="social-details">
            <h4>GitHub</h4>
            <p>github.com/mtk1606</p>
          </div>
        </a>
      </div>
      <a href="https://astrasage.com" class="social-link" target="_blank" rel="noopener noreferrer">
  <div class="social-icon">📊</div>
  <div class="social-details">
    <h4>AstraSage</h4>
    <p>Market research and product strategy services</p>
  </div>
</a>


      <a href="/assets/Mohamed_Resume.pdf" class="social-link" target="_blank">
  <div class="social-icon resume">📄</div>
  <div class="social-details">
